...
class AppState extends ChangeNotifier {
  ...
  void addJournalEntry(JournalEntry entry) {
    ...
    if (_streakDays == 0 || hasYesterday) _streakDays += 1;
    notifyListeners();
  }
  ...
  void toggleMorningCheckIn() { _morningCheckIn = !_morningCheckIn; notifyListeners(); }

  bool _memoryOfDay = true;
  bool get memoryOfDay => _memoryOfDay;
  void toggleMemoryOfDay() { _memoryOfDay = !_memoryOfDay; notifyListeners(); }

  bool _weeklySummary = false;
  bool get weeklySummary => _weeklySummary;
  void toggleWeeklySummary() { _weeklySummary = !_weeklySummary; notifyListeners(); }
  ...
  // ── Memories import ────────────────────────────────────────────────────
  void updateMemoriesImported(int count) {
